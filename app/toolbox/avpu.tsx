...
export default function AVPUScreen() {
  return (
    <AppScreen scrollable edges={["top", "bottom"]}>
      ...
      <View className="mb-6 space-y-4">
        <View className="bg-surface dark:bg-slate-900 border border-border-subtle dark:border-slate-800 border-l-4 border-l-emerald-500 rounded-2xl p-5 shadow-sm mb-4">
          <View className="flex-row items-center justify-between mb-3">
            <Text className="text-emerald-700 dark:text-emerald-400 font-bold text-lg">
              A — Alert
            </Text>
        ...
        <View className="bg-surface dark:bg-slate-900 border border-border-subtle dark:border-slate-800 border-l-4 border-l-sky-500 rounded-2xl p-5 shadow-sm mb-4">
          <View className="flex-row items-center justify-between mb-3">
            <Text className="text-sky-700 dark:text-sky-400 font-bold text-lg">
        ...
        <View className="bg-surface dark:bg-slate-900 border border-border-subtle dark:border-slate-800 border-l-4 border-l-amber-500 rounded-2xl p-5 shadow-sm mb-4">
          <View className="flex-row items-center justify-between mb-3">
            <Text className="text-amber-700 dark:text-amber-400 font-bold text-lg">
        ...
        <View className="bg-surface dark:bg-slate-900 border border-border-subtle dark:border-slate-800 border-l-4 border-l-rose-500 rounded-2xl p-5 shadow-sm mb-4">
          ...
          <Text className="text-rose-600 dark:text-rose-300 text-xs leading-5 font-semibold">
      ...
      <View className="mb-6 bg-surface dark:bg-slate-900 border-2 border-clinical-blue/30 dark:border-clinical-blue/50 rounded-2xl p-5 shadow-sm">
        <Text className="text-clinical-blue dark:text-clinical-blue font-bold text-sm mb-2 uppercase tracking-wider">
          NHS NEWS2 Update: ACVPU Scale
        </Text>
        <Text className="text-slate-600 dark:text-slate-300 text-xs leading-5">
          Modern early warning systems (such as NHS NEWS2) use <Text className="font-bold text-navy dark:text-white">ACVPU</Text>, adding <Text className="font-bold text-clinical-blue dark:text-clinical-blue">C (New Confusion)</Text> between Alert and Voice. A new onset of confusion scores 3 points on NEWS2 as a key marker of early deterioration (e.g., sepsis, hypoxia, delirium).
        </Text>
      </View>

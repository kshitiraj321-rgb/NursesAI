        ...
        <View>
          ...
          <View className="flex-row gap-2">
            ...
            >
              <Text
                className={`font-bold text-sm font-sans ${
                  direction === "kg_to_lbs" ? "text-clinical-pine dark:text-teal-400" : "text-slate-600 dark:text-slate-300"
                }`}
              >
                kg → lbs
              </Text>
              <Text className={`text-[10px] mt-0.5 font-sans ${direction === "kg_to_lbs" ? "text-clinical-pine/80 dark:text-teal-400/80 font-medium" : "text-slate-500 dark:text-slate-400"}`}>
                Kilograms to Pounds
              </Text>
            </AnimatedPressable>
            ...
            >
              <Text
                className={`font-bold text-sm font-sans ${
                  direction === "lbs_to_kg" ? "text-clinical-pine dark:text-teal-400" : "text-slate-600 dark:text-slate-300"
                }`}
              >
                lbs → kg
              </Text>
              <Text className={`text-[10px] mt-0.5 font-sans ${direction === "lbs_to_kg" ? "text-clinical-pine/80 dark:text-teal-400/80 font-medium" : "text-slate-500 dark:text-slate-400"}`}>
                Pounds to Kilograms
              </Text>
            </AnimatedPressable>
          </View>

        ...
        <View>
          ...
          <View className="flex-row gap-2">
            ...
            >
              <Text
                className={`font-bold text-sm ${
                  direction === "C_to_F" ? "text-clinical-blue dark:text-clinical-blue" : "text-slate-600 dark:text-slate-300"
                }`}
              >
                °C → °F
              </Text>
              <Text className={`text-[10px] mt-0.5 ${direction === "C_to_F" ? "text-clinical-blue/80 font-medium" : "text-slate-500 dark:text-slate-400"}`}>
            ...
            >
              <Text
                className={`font-bold text-sm ${
                  direction === "F_to_C" ? "text-clinical-blue dark:text-clinical-blue" : "text-slate-600 dark:text-slate-300"
                }`}
              >
                °F → °C
              </Text>
              <Text className={`text-[10px] mt-0.5 ${direction === "F_to_C" ? "text-clinical-blue/80 font-medium" : "text-slate-500 dark:text-slate-400"}`}>
            ...
            <View className="bg-white dark:bg-slate-900 border-2 border-clinical-blue/30 dark:border-clinical-blue/50 rounded-2xl p-5 shadow-sm">
              ...
              {result.warning && (
                <View className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 p-3.5 rounded-xl">
                  <Text className="text-amber-800 dark:text-amber-400 font-bold text-xs mb-1.5">
